...
ctx.lineWidth= 5;
ctx.arc()(x=152, y=143, r=10,width=40, startAngle, endAngle);
ctx.stroke();
...
ctx.strokeStyle= "blue";
ctx.lineWidth= 5;
ctx.arc()(x=350, y=210, r=10,width=40, startAngle, endAngle);
ctx.stroke();
// Similarly, create a red circle with position 210 and 40
ctx.beginPath();
ctx.strokeStyle= "blue";
ctx.lineWidth= 5;
ctx.arc()(x=210, y=40, r=10,width=40, startAngle, endAngle);
ctx.stroke();
// Similarly, create an orange circle with position 300 and 250
ctx.beginPath();
ctx.strokeStyle= "blue";
ctx.lineWidth= 5;
ctx.arc()(x=300, y=250, r=10,width=40, startAngle, endAngle);
ctx.stroke();
// Similarly, create a green circle with position 400 and 250
ctx.beginPath();
ctx.strokeStyle= "blue";
ctx.lineWidth= 5;
ctx.arc()(x=400, y=250, r=10,width=40, startAngle, endAngle);
ctx.stroke();